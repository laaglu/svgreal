 ...
 * <dt>twinGroup</dt><dd>Contains a visibility-hidden clone of the previous group. It is used to display the selectio and implement highlighting.</dd>
 * </dl>
 * @author laaglu
 */
public class SVGModel implements MouseDownHandler, MouseMoveHandler, MouseUpHandler, HasScalingHandlers, HasRotationHandlers {
	 ...
	 */
	public static SVGModel newInstance(OMSVGSVGElement svg, String title) {
		SVGModel model = GWT.create(SVGModel.class);
		model.setSvgElement(svg, title);
		return model;
	}
...
//		assert(model != null);
	 ...
	 */
	public void setSvgElement(OMSVGSVGElement svg, String title) {
		this.svg = svg;
	    ...
	    SVGProcessor.normalizeIds(twinGroup);
