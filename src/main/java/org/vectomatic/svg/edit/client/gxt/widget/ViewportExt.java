...
public class ViewportExt extends Viewport implements HasDropHandlers, HasDragEnterHandlers, HasDragLeaveHandlers, HasDragOverHandlers {
	...
	public HandlerRegistration addDropHandler(DropHandler handler) {
		return VectomaticApp2.getApp().getEventBus().addHandlerToSource(DropEvent.getType(), this, handler);
	}

	@Override
	public HandlerRegistration addDragLeaveHandler(DragLeaveHandler handler) {
		return VectomaticApp2.getApp().getEventBus().addHandlerToSource(DragLeaveEvent.getType(), this, handler);
	}

	@Override
	public HandlerRegistration addDragEnterHandler(DragEnterHandler handler) {
		return VectomaticApp2.getApp().getEventBus().addHandlerToSource(DragEnterEvent.getType(), this, handler);
	}

	@Override
	public HandlerRegistration addDragOverHandler(DragOverHandler handler) {
		return VectomaticApp2.getApp().getEventBus().addHandlerToSource(DragOverEvent.getType(), this, handler);
	}
