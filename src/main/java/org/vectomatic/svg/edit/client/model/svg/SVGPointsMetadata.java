...
public class SVGPointsMetadata extends MetadataBase<SVGPoints, SVGElement> {
	public SVGPointsMetadata(String propertyName, String description, IFactoryInstantiator<?> factory) {
		super(propertyName, description, null, factory);
	}
	...
	public SVGPoints set(SVGElement element, SVGPoints value) {
		...
		SVGModel svgModel = VectomaticApp2.getApp().getWindow(element).getSvgModel();
