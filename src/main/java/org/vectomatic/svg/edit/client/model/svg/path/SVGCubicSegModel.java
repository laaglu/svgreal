...
public class SVGCubicSegModel extends SVGSegModel {
	...
	public boolean equals(Object obj) {
		if (obj instanceof SVGCubicSegModel) {
			OMSVGPathSegCurvetoCubicAbs seg1 = (OMSVGPathSegCurvetoCubicAbs)element;
			OMSVGPathSegCurvetoCubicAbs seg2 = (OMSVGPathSegCurvetoCubicAbs)((SVGCubicSegModel)obj).element;
			return seg1.getX() == seg2.getX()
				&& seg1.getY() == seg2.getY()
				&& seg1.getX1() == seg2.getX1()
				&& seg1.getY1() == seg2.getY1()
				&& seg1.getX2() == seg2.getX2()
				&& seg1.getY2() == seg2.getY2();
		}
		return false;
	}
	...
	public int hashCode() {
		return get(TYPE_ID).hashCode() +
		 ...
		 + get(SVGConstants.SVG_X2_ATTRIBUTE).hashCode()
		 + get(SVGConstants.SVG_Y2_ATTRIBUTE).hashCode();
	}
