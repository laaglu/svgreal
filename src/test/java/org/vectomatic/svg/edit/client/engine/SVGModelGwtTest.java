...
public class SVGModelGwtTest extends EditTestBase {
	public void testNewInstance() {
		...
		SVGModel owner = SVGModel.newInstance(OMSVGParser.parse(data), name, SVGProcessor.newIdPrefix());
		assertNotNull(owner);
	...
	public void testCreate() {
		...
		SVGModel owner = SVGModel.newInstance(svg, "testCreate", SVGProcessor.newIdPrefix());
		...
		// Image
		SVGElement e8 = (SVGElement)new OMSVGImageElement().getElement().cast();
		SVGElement t8 = (SVGElement)new OMSVGImageElement().getElement().cast();
		SVGElementModel m8 = owner.create(e8, t8);
		assertTrue(m8 instanceof SVGImageElementModel);
		assertEquals(e8, m8.getElement());
		assertEquals(t8, m8.getTwin());
		assertEquals(owner, m8.getOwner());
	}
	...
	public void testInsertXDoc() {
		...
		SVGModel owner1 = SVGModel.newInstance(svg1, "testInsertXDoc1", SVGProcessor.newIdPrefix());
...
//		owner1.insertBefore(e1, f1, null);
		...
		SVGModel owner2 = SVGModel.newInstance(svg2, "testInsertXDoc2", SVGProcessor.newIdPrefix());
